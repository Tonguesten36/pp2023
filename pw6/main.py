...
def main():
    ...
    comp.check_if_savefiles_not_exists(save_files)

    # Extrall all data from students.tar.gz
    comp.extract_tarfile("students.tar.gz", save_files, students_list, courses_list, marks_list)
    ...
    while True:
        ...
        match op:
            ...
            case "9":    
                ...
                comp.serialize_objects(students_list, save_files[0])
                comp.serialize_objects(courses_list, save_files[1])
                comp.serialize_objects(marks_list, save_files[2])
