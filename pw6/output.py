...
def list_student(students_list):
    ...
    Parameter
    ---------
    students_list: a list of all student objects
...
def list_course(courses_list):
    ...
    Parameter
    ---------
    courses_list: a list of all course objects
...
def list_mark(marks_list):  
    ...
    Parameter
    ---------
    marks_list: a list of all mark objects
...
def average_gpa(student_id, marks_list, courses_list, display_mode=False):
    """
    Calculate average GPA of a given student  
    
    Parameters
    -----------
    student_id: ID of the student you're looking for
    marks_list: a list of mark objects
    courses_list: a list of course objects
    display_mode(=False on default): Determine whenever or not does the function return the average GPA of the student 

    Return None if display_mode=False\n
    Return Average GPA otherwise
    """
    ...
    temp_list = []
    for     mark_object in  marks_list:
        if  mark_object._get_student_id() == student_id:
            temp_list.append(mark_object._get_student_mark())
...
def sort_student(students_list, marks_list, courses_list):
    """
    Calculate average GPA of a given student  
    ...
    for student in students_list:
        temp_gpa_list.append((student._get_id(),average_gpa(student._get_id(), marks_list, courses_list, False)))
